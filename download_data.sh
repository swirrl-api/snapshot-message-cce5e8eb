...
# =======================================================
NOTEBOOK_URL=http://swirrl.localhost.com/swirrl/jupyter/4a4dacb4-b8f3-473c-82dd-9fe413900817
SERVICE_ID=4a4dacb4-b8f3-473c-82dd-9fe413900817
get_notebook http://swirrl.localhost.com/swirrl-api/v1.0/notebook 49b1d57d-6efc-436a-a523-a58d48934a19 4a4dacb4-b8f3-473c-82dd-9fe413900817
echo 'Nothing to download from data staging directory.'
download_working_dir_data ${NOTEBOOK_URL}/api/contents
delete_notebook http://swirrl.localhost.com/swirrl-api/v1.0/notebook
